...
import 'package:ex/data/categories.dart';
import 'package:ex/models/category.dart';
import 'package:ex/models/grocery_item.dart';
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null ||
                    ...
                    return 'Must be bewreen 1 and 50 characteers';
                  }
                  return null;
                },
                onSaved: (value) {
